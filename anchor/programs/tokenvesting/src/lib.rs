...
// Sets up the company's main vesting plan.
...
// This is the master account for a company's vesting plan.
//  It stores all the global details.
#[account]
...
// This is a unique account for each employee.
//  It stores their specific vesting schedule.
#[account]
#[derive(InitSpace, Debug)]
