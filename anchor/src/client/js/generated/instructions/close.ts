...
export type CloseInput<
  ...
  TAccountTokenvesting extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountTokenvesting>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountTokenvesting> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.tokenvesting),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountTokenvesting>;
